...
public class WaferFragment extends Fragment {

    String ProductGroupID = "1";
    String CustomerID,DocNo;
    RecyclerView recyclerProduct;
    ArrayList<SellModel> arrayList;
    DB database = DB.getInstance(getContext());
    public  WaferFragment(String CustomerID, String DocNo){
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //Toast.makeText(getContext(),CustomerID+" "+DocNo,Toast.LENGTH_LONG).show();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_wafer,container,false);
    }
