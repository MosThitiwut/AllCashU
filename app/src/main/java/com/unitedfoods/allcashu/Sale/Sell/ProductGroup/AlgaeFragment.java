...
public class AlgaeFragment extends Fragment {
    String ProductGroupID = "9";
    String CustomerID,DocNo;
    RecyclerView recyclerProduct;
    ArrayList<SellModel> arrayList;
    DB database = DB.getInstance(getContext());
    public  AlgaeFragment(String CustomerID, String DocNo){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_algae,container,false);
    }
    @Override
    public void onStart() {
        super.onStart();
