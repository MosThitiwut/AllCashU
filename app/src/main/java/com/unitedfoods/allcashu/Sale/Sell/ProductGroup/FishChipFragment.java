...
public class FishChipFragment extends Fragment {
    String ProductGroupID = "12";
    String CustomerID,DocNo;
    RecyclerView recyclerProduct;
    ArrayList<SellModel> arrayList;
    public  FishChipFragment(String CustomerID, String DocNo){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_fish_chip,container,false);
    }
    @Override
    public void onStart() {
        super.onStart();
